...
@Component({
  selector: 'app-no-date-list3',
  templateUrl: './no-date-list3.component.html',
  styleUrls: ['../../reservations/reservation-list/reservation-list.component.css']
})
export class NoDateList3Component implements OnInit, OnDestroy, AfterViewInit {

  newDateSub: Subscription;
  noDates: NoDate[] = [];
  @ViewChild('past') messagesForm: NgForm;
  ...
  updateNoDates() {
    this.noDates = this.noDateService.getPast();
  }
  ngAfterViewInit() {
